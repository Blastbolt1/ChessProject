...
public class StorageDoc extends Application {
				...
				if (x > -1 && x < 8 && y > -1 && y < 8) {
					if (logicBoard.logicBoard[x][y] > 0) {
						...
						case 7:
							...
							myPawn.xCoordNew = Game.arrayLogic[x][y].xCoordNew;
							myPawn.yCoordNew = Game.arrayLogic[x][y].yCoordNew;
							imageXOffset = 0.092;
							imageYOffset = 0.07;
						
							canMove = myPawn.pawnMove(logicBoard.logicBoard, Game.turn);
							break;
						case 2:
						case 8:
							Knight myKnight = new Knight(x, y, Game.arrayLogic[x][y].colour, false);
							myKnight.xCoordNew = Game.arrayLogic[x][y].xCoordNew;
							myKnight.yCoordNew = Game.arrayLogic[x][y].yCoordNew;
							imageXOffset = 0.082;
							imageYOffset = 0.02;
						
							canMove = myKnight.knightMove(logicBoard.logicBoard, Game.turn);
							break;
						case 3:
						case 9:
							Bishop myBishop = new Bishop(x, y, Game.arrayLogic[x][y].colour, false);
							myBishop.xCoordNew = Game.arrayLogic[x][y].xCoordNew;
							myBishop.yCoordNew = Game.arrayLogic[x][y].yCoordNew;
							imageXOffset = 0.1;
							imageYOffset = 0.06;
						
							canMove = myBishop.bishopMove(logicBoard.logicBoard, Game.turn);
							break;
						case 4:
						case 10:
							Rook myRook = new Rook(x, y, Game.arrayLogic[x][y].colour, false);
							myRook.xCoordNew = Game.arrayLogic[x][y].xCoordNew;
							myRook.yCoordNew = Game.arrayLogic[x][y].yCoordNew;
							imageXOffset = 0.092;
							imageYOffset = 0.03;
						
							canMove = myRook.rookMove(logicBoard.logicBoard, Game.turn);
							break;
						case 5:
						case 11:
							Queen myQueen = new Queen(x, y, Game.arrayLogic[x][y].colour, false);
							myQueen.xCoordNew = Game.arrayLogic[x][y].xCoordNew;
							myQueen.yCoordNew = Game.arrayLogic[x][y].yCoordNew;
							imageXOffset = 0.092;
							imageYOffset = 0.03;
						
							canMove = myQueen.queenMove(logicBoard.logicBoard, Game.turn);
							break;
						case 6:
						case 12:
							King myKing = new King(x, y, Game.arrayLogic[x][y].colour, false);
							myKing.xCoordNew = Game.arrayLogic[x][y].xCoordNew;
							myKing.yCoordNew = Game.arrayLogic[x][y].yCoordNew;
							imageXOffset = 0.092;
							imageYOffset = 0.06;
							
							canMove = myKing.kingMove(logicBoard.logicBoard, Game.turn);
							break;
						default:
							break;
						}
						
						Game.movePiece(canMove, Game.pieceGraphicsMaster[x][y], Game.arrayLogic[x][y], logicBoard.logicBoard, xint, yint, logicBoard.logicBoard[x][y], imageXOffset, imageYOffset);
					}
				}
			}
		});
